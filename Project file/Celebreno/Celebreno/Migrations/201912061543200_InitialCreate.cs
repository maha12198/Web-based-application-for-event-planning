                ...
                c => new
                    {
                        ...
                        ServicePackId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Item_ID)
                .ForeignKey("dbo.ServicePacks", t => t.ServicePackId, cascadeDelete: true)
                .Index(t => t.ServicePackId);
                ...
                c => new
                    {
                        ...
                        EventTypeName = c.String(nullable: false, maxLength: 100),
