<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="Celebreno.Account.OpenAuthProviders" %>
...
<div id="socialLoginList">
    ...
    <asp:ListView runat="server" ID="providerDetails" ItemType="System.String"
        ...
        <ItemTemplate>
            <p>
               <button type="submit" class="btn btn-outline-primary" name="provider" value="<%#: Item %>"
